...
void LoadEnemies::initiliseEnemies(std::string _waveFile, Scene* _scene) {
	...
	for (int index = 0; index < ls::findTiles(ls::SERGEANT).size(); index++) {
		...
		enemySettings settings(100, 1000, 2.5, _scene, ls::SERGEANT, .4f, .005f, { 0.f,-300.f }, ENEMY, true, { 1.f,2.f }, { 1.f,1.f }, ENEMY_BULLET);
	...
	for (int index = 0; index < ls::findTiles(ls::COLONEL).size(); index++) {
		...
		enemySettings settings(100, 1000, 3.5, _scene, ls::COLONEL, .4f, .005f, { 0.f,-300.f }, ENEMY, true, { 1.f,2.f }, { 1.f,1.f }, ENEMY_BULLET);
