...
void PhysicsComponent::setCategory(_entityCategory cat)
{
    ...
    case PLAYER_BODY:
        ...
        filter.maskBits = ENEMY_BODY | ENEMY_BULLET | ENEMY_MISSILE | POWERUP | ENEMY_MISSILE_RADAR | KAMIKAZE; //only collides with enemy group
        break;
    case ENEMY_BODY:
    ...
    case FRIENDLY_BULLET:
        ...
        filter.maskBits = ENEMY_BODY | ENEMY_MISSILE | KAMIKAZE;
        break;
    case FRIENDLY_MISSILE:
        filter.categoryBits = FRIENDLY_MISSILE;
        filter.maskBits = ENEMY_BODY | ENEMY_BULLET | ENEMY_MISSILE | KAMIKAZE;
        break;
